...
// import "https://github.com/nitika-goel/openzeppelin-solidity/blob/master/contracts/crowdsale/validation/IndividuallyCappedCrowdsale.sol";
...
contract DDRCrowdsale is Crowdsale, MintedCrowdsale, CappedCrowdsale, TimedCrowdsale, RefundablePostDeliveryCrowdsale { 
    ...
    constructor(
        ...
        // uint cap // the cap for each individual buyer
        ) public 
...
contract DDRCoinCrowdsaleDeployer {
    // Create an `address public` variable called `ddr_token_address` which will store DDRCoin's address once that contract has been deployed
